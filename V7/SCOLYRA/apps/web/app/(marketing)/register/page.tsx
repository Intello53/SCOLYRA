        ...
        {step === "identite" && (
          ...
          >
            ...
            <label className="flex items-start gap-2 text-sm text-ink-900/70">
              ...
              />
              J'accepte les{" "}
              <Link href="/cgu" target="_blank" className="text-primary-600 hover:underline">
                CGU
              </Link>{" "}
              et la{" "}
              <Link href="/confidentialite" target="_blank" className="text-primary-600 hover:underline">
                politique de confidentialité
              </Link>
              .
            </label>
            <Button type="submit" className="w-full" disabled={!acceptedTerms}>Continuer</Button>
          </motion.form>
        )}
